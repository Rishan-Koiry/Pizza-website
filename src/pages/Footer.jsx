    ...
    <footer className="bg-gray-900 text-gray-300 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About Section */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Pizza RK</h3>
            <p className="text-sm leading-relaxed mb-4">
              Serving the finest wood-fired pizzas since 2020. Fresh
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex justify-between">
                <span>Saturday:</span>
                <span className="text-orange-400">11:00 AM - 11:00 PM</span>
              </li>
              <li className="flex justify-between">
                <span>Sunday:</span>
                <span className="text-orange-400">11:00 AM - 9:00 PM</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Pizza RK. All rights reserved.
          </p>
